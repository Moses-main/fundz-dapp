...
const mockContributions = [
  {
    ...
    campaignImage: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80',
    amount: 500,
    currency: 'ETH',
    amountUSD: 1000,
  ...
  },
  {
    ...
    campaignImage: 'https://images.unsplash.com/photo-1445205170230-053b83016042?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80',
    amount: 100,
    currency: 'USDC',
    amountUSD: 100,
  ...
  },
  {
    ...
    campaignImage: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
    amount: 250,
    currency: 'ETH',
    amountUSD: 500,
  ...
  },
  {
    ...
    campaignImage: 'https://images.unsplash.com/photo-1531913764164-f85c52d6e654?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1433&q=80',
    amount: 50,
    currency: 'USDC',
    amountUSD: 50,
...
const Contributions = () => {
  ...
  const filteredContributions = mockContributions.filter(contribution => {
    const matchesSearch = contribution.campaignTitle.toLowerCase().includes(searchQuery.toLowerCase());
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">My Contributions</h2>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Contributed</p>
            <p className="text-lg font-semibold text-gray-900 dark:text-white">$1,650.00</p>
          </div>
        </div>
      </div>
        ...
        {sortedContributions.length > 0 ? (
          <ul className="divide-y divide-gray-200 dark:divide-gray-700">
            {sortedContributions.map((contribution) => (
              <li key={contribution.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <div className="px-4 py-4 sm:px-6">
                          ...
                          <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            {contribution.refundDate && (
                              <span className="text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 px-2 py-0.5 rounded-full">
                                Refunded on {new Date(contribution.refundDate).toLocaleDateString()}
                              </span>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center space-x-2">
                      ...
                      {contribution.isRefundable && contribution.status === 'confirmed' && (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No contributions found</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
