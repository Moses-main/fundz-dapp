      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Support innovative projects and be part of something bigger. Every contribution makes a difference.
          </p>
        </div>
            ...
            {filteredCampaigns.map((campaign) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={campaign.image || 'https://via.placeholder.com/400x300?text=Campaign+Image'}
                    alt={campaign.title}
                  ...
                  <div className="mt-auto">
                    <div className="mb-3">
                      <div className="flex justify-between text-sm text-gray-600 dark:text-gray-400 mb-1">
                        ...
                        <span>{Math.min(100, Math.round((campaign.raised / campaign.goal) * 100))}%</span>
                      </div>
