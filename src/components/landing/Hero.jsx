    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          >
            Launch campaigns, share across your network, and get funded globally with crypto or fiat.
          </motion.p>
          ...
          >
            <div className="flex items-center">
              <div className="flex -space-x-2 overflow-hidden">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="inline-block h-8 w-8 rounded-full ring-2 ring-gray-800 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto bg-white/5 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/10">
            ...
            <div className="relative px-6 py-8 sm:p-10">
              <div className="flex items-center space-x-2 text-sm font-medium text-indigo-400 mb-6">
                <span className="px-3 py-1 bg-indigo-500/10 rounded-full border border-indigo-400/20">🔥 Trending</span>
                <span>Featured Campaign</span>
              </div>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-white">EcoCrypto: Green Energy Initiative</h3>
                  <p className="mt-2 text-gray-300">Support our mission to bring renewable energy to underserved communities using blockchain technology.</p>
                  <div className="mt-4 flex items-center">
                    <div className="w-full bg-gray-700 rounded-full h-2.5">
                      <div className="bg-gradient-to-r from-green-400 to-emerald-500 h-2.5 rounded-full" style={{ width: '75%' }}></div>
                    </div>
                    <span className="ml-4 text-sm font-medium text-gray-300">75% funded</span>
                  </div>
                  <div className="mt-4 flex flex-wrap items-center justify-between text-sm text-gray-400 gap-4">
                    <span>Raised: <span className="font-medium text-white">$37,500</span></span>
                    <span>Goal: <span className="font-medium text-white">$50,000</span></span>
                    <span>Backers: <span className="font-medium text-white">128</span></span>
                    <span>Days Left: <span className="font-medium text-white">12</span></span>
                  </div>
                </div>
                <Link
                  to="/campaigns/ecocrypto"
